...
# ---------------------------------------------------------------------------- #
# Segmentation-based Detection Head
# ---------------------------------------------------------------------------- #
_C.MODEL.SEG_DET_HEAD = CN()
_C.MODEL.SEG_DET_HEAD.NAME = "SegDetFPNHead"
_C.MODEL.SEG_DET_HEAD.IN_FEATURES = ["p2", "p3", "p4", "p5"]
# Label in the semantic segmentation ground truth that is ignored, i.e., no loss is calculated for
# the correposnding pixel.
_C.MODEL.SEG_DET_HEAD.IGNORE_VALUE = 255
# Number of classes in the semantic segmentation head
_C.MODEL.SEG_DET_HEAD.NUM_CLASSES = 80
# Number of channels in the 3x3 convs inside semantic-FPN heads.
_C.MODEL.SEG_DET_HEAD.CONVS_DIM = 128
# Outputs from semantic-FPN heads are up-scaled to the COMMON_STRIDE stride.
_C.MODEL.SEG_DET_HEAD.COMMON_STRIDE = 4
# Normalization method for the convolution layers. Options: "" (no norm), "GN".
_C.MODEL.SEG_DET_HEAD.NORM = "GN"
_C.MODEL.SEG_DET_HEAD.LOSS_WEIGHT = 1.0

# ---------------------------------------------------------------------------- #
# Deeplab-based Detection Head
# ---------------------------------------------------------------------------- #
_C.MODEL.DL_DET_HEAD = CN()
_C.MODEL.DL_DET_HEAD.NAME = "DLDetFPNHead"
_C.MODEL.DL_DET_HEAD.IN_FEATURES = ["p3", "p4", "p5"]  # "p2", 
# Label in the semantic segmentation ground truth that is ignored, i.e., no loss is calculated for
# the correposnding pixel.
_C.MODEL.DL_DET_HEAD.IGNORE_VALUE = 255
# Number of classes in the semantic segmentation head
_C.MODEL.DL_DET_HEAD.NUM_CLASSES = 80
# Number of channels in the 3x3 convs inside semantic-FPN heads.
_C.MODEL.DL_DET_HEAD.CONVS_DIM = 128
# Outputs from semantic-FPN heads are up-scaled to the COMMON_STRIDE stride.
_C.MODEL.DL_DET_HEAD.COMMON_STRIDE = 4
# Normalization method for the convolution layers. Options: "" (no norm), "GN".
_C.MODEL.DL_DET_HEAD.NORM = "GN"
_C.MODEL.DL_DET_HEAD.LOSS_WEIGHT = 1.0
# ---------------------------------------------------------------------------- #
