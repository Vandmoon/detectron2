...
#             pathtd[i - 1] = (w1[0, i-1]*pathtd[i - 1] + w1[1, i-1]*F.interpolate(pathtd[i], size=[pathtd[i-1].size()[-2],pathtd[i-1].size()[-1]], mode='nearest'))/(w1[0, i-1] + w1[1, i-1] + self.eps)
...
#             pathtd[i + 1] = (w2[0, i] * pathtd[i + 1] + w2[1, i] * F.adaptive_max_pool2d(pathtd[i], [pathtd[i + 1].size()[-2], pathtd[i + 1].size()[-1]]) + w2[2, i] * inputs_clone[i + 1])/(w2[0, i] + w2[1, i] + w2[2, i] + self.eps)
            pathtd[i + 1] = self.bifpn_convs[idx_bifpn](pathtd[i + 1])
            idx_bifpn = idx_bifpn + 1
...
#         pathtd[levels - 1] = (w1[0, levels-1] * pathtd[levels - 1] + w1[1, levels-1] * F.adaptive_max_pool2d(pathtd[levels - 2], [pathtd[levels - 1].size()[-2], pathtd[levels - 1].size()[-1]]))/(w1[0, levels-1] + w1[1, levels-1] + self.eps)
